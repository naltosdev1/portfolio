        ...
        <div className='flex-col mt-12 flex'>
            ...
            <div className='grid grid-cols-3 gap-2 mt-6'>
              <div className='relative p-4 w-70 h-15 flex bg-neutral-800 rounded border-b-4 border-blue-600 transition duration-150 ease-in-out hover:shadow-md hover:shadow-black'>
                <Image src={typescript} className='w-10 h-10 transition duration-150 ease-in-out hover:skew-y-12' />
              ...
              <div className='relative p-4 w-70 h-15 flex bg-neutral-800 rounded border-b-4 border-blue-600 transition duration-150 ease-in-out hover:shadow-md hover:shadow-black'>
                <Image src={javascript} className='w-10 h-10 transition duration-150 ease-in-out hover:skew-y-12' />
              ...
              <div className='relative p-4 w-70 h-15 flex bg-neutral-800 rounded border-b-4 border-blue-600 transition duration-150 ease-in-out hover:shadow-md hover:shadow-black'>
                <Image src={nodejs} className='w-10 h-11 transition duration-150 ease-in-out hover:skew-y-12'/>
                <h2 className='pl-2 pt-1 font-roboto text-xl text-white font-semibold bg-transparent'>ExpressJS</h2>
                <p className='flex absolute top-1 right-3 text-green-600 font-semibold font-roboto'>Amateur</p>
              </div>
              <div className='relative p-4 w-70 h-15 flex bg-neutral-800 rounded border-b-4 border-blue-600 transition duration-150 ease-in-out hover:shadow-md hover:shadow-black'>
                <Image src={nextjs} className='w-10 h-11 transition duration-150 ease-in-out hover:skew-y-12'/>
              ...
              <div className='relative p-4 w-70 h-15 flex bg-neutral-800 rounded border-b-4 border-blue-600 transition duration-150 ease-in-out hover:shadow-md hover:shadow-black'>
                <Image src={php} className='w-10 h-11 transition duration-150 ease-in-out hover:skew-y-12'/>
